...
# Create and configure the buttons with colors and horizontal arrangement
button_frame = tk.Frame(root)
button_frame.pack()

add_button = tk.Button(button_frame, text="Add Task", command=add_task, bg="green", fg="white")
add_button.pack(side=tk.LEFT, padx=5, pady=5)

remove_button = tk.Button(button_frame, text="Remove Task", command=remove_task, bg="red", fg="white")
remove_button.pack(side=tk.LEFT, padx=5, pady=5)

update_button = tk.Button(button_frame, text="Update Task", command=update_task, bg="blue", fg="white")
